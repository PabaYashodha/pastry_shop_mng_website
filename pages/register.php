...
<section style="min-height: 100vh;">
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="card mb-3" style="margin-top: 70px; border:none">
                    ...
                    <form action="../handler/CustomerHandler.php?status=newCustomer" method="post" role="form" id="customerForm" class="mx-2 mt-1 needs-validation" novalidate>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control" id="customerEmail" name="customerEmail" onchange="emailValidate(); " required value="<?php echo $_REQUEST['email']; ?>" readonly>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="password" class="form-control" id="newPassword" name="newPassword" required onchange="passwordValidate();">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="password" class="form-control" id="confirmPassword" name="confirmPassword" required onchange="passwordMatching();">
                                <div class="invalid-feedback">
                                Field is required
                                </div>
                            </div>
            ...
            <div class="col">
            <div class="card mb-3" style="margin-top: 70px; border:none">
            <img src="../img/coffee.webp" class="img-fluid rounded-3 " alt="...">
            </div> 
            </div>
        </div>
    </div>
